...
public class Person {
	 ...
	 * Person with default values. It also generates
	 *  an ID based on the hash code of concatenated 
	 *  object attributes.
	 */
	public Person() {
		super();
	 ...
	 * Person with specified values.
	 */
	public Person(Long id, Name name, Location location,
	 ...
	 * Person instance from an existing one.
	 * 
	 */
	...
	/*
	 *Getter method for retrieving the 
	 *Funds information of the person.
	 * 
	 */
	...
	/*
	 * Overrides the toString method to provide 
	 * a custom string representation of the person.
	 * 
	 */
	@Override
