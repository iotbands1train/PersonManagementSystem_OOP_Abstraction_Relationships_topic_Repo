...
import module04.oop.models.StackOfPersons;
/**
 * The main class for managing a stack of persons.
 * This class provides a user interface for interacting
 *  with a stack of Person objects.
 */
public class PersonManager {
	static Scanner inpt=new Scanner(System.in);
	   /**
     * The main method that serves as the entry 
     * point of the program.
     * It displays a menu to the user and handles
     *  user choices for managing the stack of persons.
     *
	...
	public static void main(String[] args) {
		...
		bulkStackPersons(stack, max, "preLoad");
		 // Populate the stack with initial data
		while (true) {
			// Display stack capacity and person count
			...
			case 2:
                // Display all persons in the stack
    ...
    /**
     * Populate the stack with a random number of persons.
     *
     * @param stack The StackOfPersons instance to populate
     * @param max   The maximum number of persons to generate
     * @param pre   A description of the population mode
     */
    ...
    /**
     * Populate the stack with a specified number of persons.
     *
     * @param stk The StackOfPersons instance to populate
     * @param max The maximum number of persons to generate
     * @return The updated StackOfPersons instance
     */
    ...
    /**
     * Display an update menu for changing different attributes of a person.
     *
     * @param foundPerson The person to update
     ...
     *
     * @param foundPerson The person whose name is to be updated
     * @return The updated person
     */
    ...
    /**
     * Update the phone number of a person.
     *
     * @param foundPerson The person whose phone number is to be updated
     * @return The updated person
     */
     ...
     *
     * @param foundPerson The person whose salary is to be updated
     * @return The updated person
     */
